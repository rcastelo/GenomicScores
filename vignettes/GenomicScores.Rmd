...
par(mar=c(3, 5, 1, 1))
bp <- barplot(t(as.matrix(mcols(eyecolormafs))), beside=TRUE, col=c("darkblue", "darkgreen", "darkorange"),
...
We can also additionally annotate MAF values on these variants. However,
