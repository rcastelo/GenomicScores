...
The specific quantization and dequantization functions are stored as part of the metadata of a
`GScores` object and they can be examined with the methods `qfun()` and `dqfun()`, respectively.
The latter is called by the scores() method to retrieve genomic scores.
