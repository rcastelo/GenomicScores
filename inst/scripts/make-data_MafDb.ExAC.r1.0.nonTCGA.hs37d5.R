...
## and store them using only one significant digit to reduce the
## memory footprint through RleList objects
...
## save rsID assignments from ExAC for SNVs
rr <- rowRanges(vcf)
