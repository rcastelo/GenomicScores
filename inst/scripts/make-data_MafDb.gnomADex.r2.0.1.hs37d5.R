...
##
## gsutil -m cp -r gs://gnomad-public/release-170228/vcf/exomes/gnomad.exomes.r2.0.1.sites.vcf.gz gnomad_data
## wget https://data.broadinstitute.org/gnomAD/release-170228/exomes/vcf/gnomad.exomes.r2.0.1.sites.vcf.gz.tbi
...
vcfFilename <- "gnomad.exomes.r2.0.1.sites.vcf.gz"
genomeversion <- "hs37d5"
pkgname <- sprintf("MafDb.gnomADex.r2.0.1.%s", genomeversion)
dir.create(pkgname)
...
## some rsID assignments consist of several rsIDs
## separated by semicolon ';', assign just the first one
