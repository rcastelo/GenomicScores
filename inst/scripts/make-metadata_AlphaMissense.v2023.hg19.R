...
makeMetadata_AlphaMissense.v2023.hg19 <- function()
{
  biocver <- "3.18"
  baseUrl <- "https://functionalgenomics.upf.edu/annotationhub/alphamissense/"
  meta <- .GenomicScoresMetadataFromUrl(baseUrl, "AlphaMissense.v2023.hg19")
  n <- nrow(meta)
  data.frame(
...
metadata <- makeMetadata_AlphaMissense.v2023.hg19()
write.csv(metadata, file="../extdata/metadata_AlphaMissense.v2023.hg19.csv", row.names=FALSE)
